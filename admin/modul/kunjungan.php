                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="rujukan.php" method="post">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <input type="hidden" name="diagnosa_sementara" value="<?php echo $data['diagnosa2'] ?>">
                                                                                        <input type="hidden" name="tindakan" value="<?php echo $data['tindakan'] ?>">
                                                                                        <input type="hidden" name="anamnesi" value="<?php echo $data['diagnosa1'] ?>">
                                                                                        <input type="hidden" name="pemeriksaan" value="<?php echo $data['keterangan'] ?>">
